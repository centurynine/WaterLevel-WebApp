...
function Info() {
  ...
  return (
    <div>
      <div className="flex flex-col xl:flex-row items-center justify-center mt-40">
        <div className=" mb-20 md:mb-10 md:ml-56 md:mr-40 flex flex-col items-center justify-center ">
          ...
          <div className="flex flex-row gap-2 justify-center text-xl md:text-4xl font-medium bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-blue-400 text-center">
            <span className="mx-10 md:mx-0 mb-32">
        ...
        <div className="text-center">
          ...
          {isVisible && (
            <div className="slide-in-from-left">
              <div className="flex flex-row justify-center items-center gap-x-2 px-10 md:px-0 md:gap-x-24 mb-20 ">
                <div className="">
                  <Image
                    src={motherboard}
                    alt="profile"
                ...
                <div className="flex flex-col">
                  <span className="text-3xl md:text-6xl my-10 text-slate-800">Node</span>
              ...
              {/* Wifi */}
              <div className="slide-in-from-left">
                <div className="flex flex-row justify-center items-center gap-x-2 px-10 md:px-0 md:gap-x-44 mb-40 ">
                  <div className="flex flex-col">
                    <span className="text-3xl md:text-6xl my-10 text-slate-800">
                      Connection
                    </span>
