      ...
      <ul>
        <div className='flex flex-row space-x-4 mr-10'>
          <div className='flex-row gap-4 hidden sm:hidden md:flex md:gap-4'> 
            ...
            <li><a href='#info' className= 'hover:text-cyan-500 transition'>Info</a></li>
          ...
          <li><a className='bg-gradient-to-r from-cyan-500 to-blue-400 
                 text-white px-4 py-2 border-none rounded-2xl ml-4 hover:opacity-80 transition' href='' target='_blank' rel="noopener noreferrer">Install</a></li>
        </div>
      </ul>
    </nav>
  )
